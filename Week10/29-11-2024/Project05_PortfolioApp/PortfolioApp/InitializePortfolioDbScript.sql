...
-- Trigger Abouts
create trigger trg_UpdateAt_Abouts
on Abouts
after update
as
begin
...
-- Trigger Categories
create trigger trg_UpdateAt_Categories
on Categories
after update
as
begin
...
-- Trigger Contacts
create trigger trg_UpdateAt_Contacts
on Contacts
after update
as
begin
...
-- Trigger HomeBanners
create trigger trg_UpdateAt_HomeBanners
on HomeBanners
after update
as
begin
...
-- Trigger Projects
create trigger trg_UpdateAt_Projects
on Projects
after update
as
begin
...
-- Trigger ServiceInfos
create trigger trg_UpdateAt_ServiceInfos
on ServiceInfos
after update
as
begin
...
-- Trigger Services
create trigger trg_UpdateAt_Services
on Services
after update
as
begin
...
-- Trigger Settings
create trigger trg_UpdateAt_Settings
on Settings
after update
as
begin
...
-- Trigger SocialMediaAccounts
create trigger trg_UpdateAt_SocialMediaAccounts
