...
namespace ECommerce.API.Controllers
{
    ...
    public class OrdersController : CustomControllerBase
    {
        ...
        [Authorize]
        [HttpGet("daterange")]
        public async Task<IActionResult> GetOrdersByDateRange([FromQuery] DateTime startDate, [FromBody] DateTime endDate)
        {
        ...
        [Authorize]
        [HttpGet("status")]
        public async Task<IActionResult> GetOrdersByStatus([FromBody] OrderStatus orderStatus)
        {
